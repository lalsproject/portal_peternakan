	...
	<div id="main-wrapper">
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a href="<?php echo site_url('profile') ?>" class="sidebar-link"><i class="fa fa-user"></i><span class="hide-menu"> Profil Dinas</span></a></li>
		...
		<div class="page-wrapper">
			...
			<footer class="footer text-center">
				   All Rights Reserved by Yohanes Farly Rakinaung. Designed and Developed use <a href="#;">💜</a>  - Page rendered in <strong>{elapsed_time}</strong> seconds..
			</footer>
			<!-- ============================================================== -->
			<!-- End footer -->
			<!-- ============================================================== -->
